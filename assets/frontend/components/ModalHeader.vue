...
<template>
  <div class="relative border-b border-stone-100 px-6 py-5 pr-20">
    ...
    <button type="button" class="absolute right-6 top-5 inline-grid h-10 w-10 place-items-center rounded-full border border-stone-200 text-stone-500 transition hover:border-stone-300 hover:text-stone-800" @click="$emit('close')">
